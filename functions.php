...
function convData($id, $type = '')
{
    ...
    if ($type == 'photo') {
        ...
        if (mb_strlen($arytemp['text']) > 49) {
            $arytemp['text'] = mb_substr($arytemp['text'], 0, 49) . '…';
        }
...
function SNS_btn_horizontal_head($url, $title)
{
	...
	<div class="sns_head sns_button">
		<ul class="list-inline">
			<li class="facebook">
				<a href="http://www.facebook.com/sharer.php?src=bm&u=<?= $url ?>&t=<?= $title ?>"
				   onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
				   target="blank" title="Facebookでシェア！">
					<span><b class="share-num">&nbsp;<?php if (function_exists('scc_get_share_facebook')) {
                                echo (scc_get_share_facebook() == 0) ? '0' : scc_get_share_facebook();
                            } ?></b></span>
				</a>
			</li>
			<li class="twitter">
				<a href="http://twitter.com/intent/tweet?url=<?= $url ?>&text=<?= $title ?>&tw_p=tweetbutton"
				   target="blank" title="ツイートする！">
					<span><b class="share-num">&nbsp;<?php if (function_exists('scc_get_share_twitter')) {
                                echo (scc_get_share_twitter() == 0) ? '0' : scc_get_share_twitter();
                            } ?></b></span>
				</a>
			</li>
			<li class="google">
				<a href="https://plus.google.com/share?url=<?= $url ?>"
				   ...
				   target="blank" title="+1する！">
					<span><b class="share-num">&nbsp;<?php if (function_exists('scc_get_share_gplus')) {
                                echo (scc_get_share_gplus() == 0) ? '0' : scc_get_share_gplus();
                            } ?></b></span>
				</a>
			</li>
		</ul>
